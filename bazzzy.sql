...
INSERT INTO `dostawca` VALUES (11,'123','213','213','213','213');
...
INSERT INTO `magazyn` VALUES (1,'w');
...
INSERT INTO `oferta` VALUES (3,31,11,13,11);
...
CREATE TABLE `paczka` (
  ...
  `dostawa_id_dostawy` int NOT NULL,
  ...
  KEY `fk_paczka_dostawa1_idx` (`dostawa_id_dostawy`),
  CONSTRAINT `fk_paczka_dostawa1` FOREIGN KEY (`dostawa_id_dostawy`) REFERENCES `dostawa` (`id_dostawy`),
...
CREATE TABLE `produkt_opisowy` (
  ...
  `Jednostki_w_sztuce` float NOT NULL,
  ...
  `Dlugosc_nominalna` float DEFAULT NULL,
  `Szerokosc_nominalna` float DEFAULT NULL,
  `Grubosc` float DEFAULT NULL,
  `Struktura` varchar(45) DEFAULT NULL,
  `Gradacja` int DEFAULT NULL,
  `Srednica` int DEFAULT NULL,
...
-- Dump completed on 2023-01-20  0:16:23
